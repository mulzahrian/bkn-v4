                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <marquee>Selamat Datang di Kantor Regional XII BKN Pekanbaru Kawasan Bebas Korupsi (WBK) Professional, Bermartabat dan Berintegritasi</marquee>
                                    </div>
                                </div>
                                <div class="col-auto">
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="card bg-primary text-white shadow mb-2">
                        ...
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h3 class="m-0 font-weight-bold text-primary" style="text-align:center">COUNTER C</h3>
